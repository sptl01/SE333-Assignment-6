...
public class BookstoreUITest {
    ...
    public void completePurchaseFlow() throws InterruptedException {
        ...
        try {
            ...
            try { page.click("text=Brand"); Thread.sleep(1000); page.click("text=JBL"); Thread.sleep(1500); System.out.println("Filtered by Brand: JBL"); }
            catch (Exception e) { System.out.println("Brand filter skipped"); }

            try { page.click("text=Color"); Thread.sleep(1000); page.click("text=Black"); Thread.sleep(1500); System.out.println("Filtered by Color: Black"); }
            catch (Exception e) { System.out.println("Color filter skipped"); }

            try { page.click("text=Price"); Thread.sleep(1000); page.click("text=Over $50"); Thread.sleep(1500); System.out.println("Filtered by Price: Over $50"); }
            catch (Exception e) { System.out.println("Price filter skipped"); }
